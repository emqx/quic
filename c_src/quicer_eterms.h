...
extern ERL_NIF_TERM ATOM_QUIC_STATUS_PERMISSION_DENIED;
extern ERL_NIF_TERM ATOM_QUIC_STATUS_EPOLL_ERROR;
extern ERL_NIF_TERM ATOM_QUIC_STATUS_DNS_RESOLUTION_ERROR;
extern ERL_NIF_TERM ATOM_QUIC_STATUS_SOCKET_ERROR;
