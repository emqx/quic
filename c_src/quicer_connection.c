...
void
WriteSslKeyLogFile2(_In_z_ const char *FileName,
                         ...
                         QUIC_CONNECTION_EVENT *Event)
{
  ...
  switch (Event->Type)
    ...
    case QUIC_CONNECTION_EVENT_CONNECTED:
      ...
      if (NULL != c_ctx->l_ctx->ssl_key_log_file && NULL != c_ctx->TlsSecrets)
        {
          WriteSslKeyLogFile2(c_ctx->l_ctx->ssl_key_log_file,
                              *(c_ctx->TlsSecrets));
        }
      break;
    case QUIC_CONNECTION_EVENT_SHUTDOWN_INITIATED_BY_TRANSPORT:
